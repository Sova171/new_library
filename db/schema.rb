...
ActiveRecord::Schema[7.0].define(version: 2022_10_12_134500) do
  ...
  create_table "rating_counts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id", "rating_id", "counts"], name: "index_rating_counts_on_book_id_and_rating_id_and_counts", unique: true
